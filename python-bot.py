...
OWNER_ID = 5635381921 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@keofreehupdi"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
...
bot = telebot.TeleBot(7491620679:AAGWfFr49zsNSlscDJxIxXRdPgq2qUsz5OE)
